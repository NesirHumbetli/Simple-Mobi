<section id="blogs">
    <div class="container py-4">
        <h4 class="font-size-20 font-rubik">Latest Blogs</h4>
        <hr>
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                    ...
                    <p class="card-text font-size-14 text-black-50 py-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum expedita ex ut est nam. Consequatur necessitatibus nam cum. Soluta, saepe.</p>

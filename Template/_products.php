...
$sale_list = $product->getData();
foreach ($sale_list as $val1):
    if ($val1['item_id'] == $item_id):
        ?>
        ...
        <section id="product" class="py-3">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img src="<?=$val1['item_image']??'./assets/products/1.png';?>" alt="product" class="img-fluid">
                        <div class="form-row pt-4 font-size-16 font-baloo">
                            ...
                            <div class="col">
                                <form method="post">
                                    <input type="hidden" name="item_id" value="<?=$val1['item_id'];?>">
                                    <input type="hidden" name="user_id" value="<?=1;?>">
                                    <button type="submit" name="submit_top_sale"  class="btn btn-warning form-control">Add to Cart</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 py-5">
                        <h5 class="font-baloo font-size-20"><?=$val1['item_name']??'Unknown';?></h5>
                        <small>by <?=$val1['item_brand']??'Brand';?></small>
                        <div class="d-flex">
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-rale font-size-14">
                                <td>Deal Price:</td>
                                <td class="font-size-20 text-danger">$<span><?=$val1['item_price']??0;?></span><small
